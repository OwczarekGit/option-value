...
export class OptionArray<T> extends Array<T> {
    ...
    */
    public maybeFindIndex(predicate: (value: T, index: number, obj: T[]) => unknown): Option<number> {
    ...
    */
    public maybeFind(predicate: (value: T, index: number, obj: T[]) => unknown): Option<T> {
    ...
    */
    public maybeIndexOf(searchElement: T, fromIndex?: number): Option<number> {
